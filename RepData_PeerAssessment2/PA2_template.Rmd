...
```{r load_supplemental2a, message=FALSE, eval=FALSE}
...
```{r figure3, fig.width=8, fig.height=5, fig.show="hide"}
...
```{r figure4, fig.width=8, fig.height=5, fig.show="hide"}
