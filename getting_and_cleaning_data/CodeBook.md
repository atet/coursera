...
## NOTE: THIS MUST BE SET CORRECTLY TO ONE LEVEL ABOVE WHERE YOU EXTRACTED YOU SAMSUNG DATA FILES.
## Set working directory to my local directory where the files are located
setwd("~/git_coursera/getting_and_cleaning_data")
## After setting my directory above, my Samsung data files would be in "./UCI HAR Dataset"
